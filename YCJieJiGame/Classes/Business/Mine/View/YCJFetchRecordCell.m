...
@implementation YCJFetchRecordCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    YCJFetchRecordCell *cell = (YCJFetchRecordCell *)[tableView dequeueReusableCellWithIdentifier:kReuseIdentifier];
    if (!cell) {
...
- (UILabel *)centerLabel{
    if (!_centerLabel) {
        ...
        _centerLabel.textColor = kColorHex(0x21A22E);
        _centerLabel.text = @"抓取成功";
