...
- (void)sureBtnAction {
    ...
    [JKNetWorkManager postRequestWithUrlPath:JKAccountModifyUrlKey parameters:@{@"accessToken":[YCJUserInfoManager sharedInstance].userTokenModel.accessToken, @"nickname": self.nameTF.text} finished:^(JKNetWorkResult * _Nonnull result) {
        [self dismiss];
