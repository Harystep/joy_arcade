...
//  YCJieJiGame
//
//  Created by ITACHI on 2023/5/26.
//

#import "YCJVIPProcessView.h"

@interface YCJVIPProcessView (){
...
@implementation YCJVIPProcessView
...
- (void)reload {
    if ([YCJUserInfoManager sharedInstance].userInfoModel) {
        MemberLevelDto *memb = [YCJUserInfoManager sharedInstance].userInfoModel.memberLevelDto;
