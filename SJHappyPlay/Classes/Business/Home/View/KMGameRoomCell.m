                          ...
                          forIndexPath:(NSIndexPath *)indexPath
{
    ...
    KMGameRoomCell *cell =
        [collectionView dequeueReusableCellWithReuseIdentifier:[KMGameRoomCell cellIdentifier]
...
- (void)setRoomModel:(KMRoomListModel *)roomModel {
