                          ...
                          forIndexPath:(NSIndexPath *)indexPath
{
    ...
    QAExchangeCell *cell =
        [collectionView dequeueReusableCellWithReuseIdentifier:[QAExchangeCell cellIdentifier]
...
- (void)setExchangeModel:(QAExchangeModel *)exchangeModel {
