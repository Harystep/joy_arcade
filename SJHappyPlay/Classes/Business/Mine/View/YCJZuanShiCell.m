...
#import "YCJZuanShiCell.h"
#import "YCJConsumeModel.h"

@interface YCJZuanShiCell ()
...
@implementation YCJZuanShiCell


+ (instancetype)cellWithTableView:(UITableView *)tableView{
    YCJZuanShiCell *cell = (YCJZuanShiCell *)[tableView dequeueReusableCellWithIdentifier:kReuseIdentifier];
    if (!cell) {
