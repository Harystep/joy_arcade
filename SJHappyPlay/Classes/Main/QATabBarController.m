...
- (void)setupViewControllers{
    ...
    [self addControllerWithClass:[YCJRankViewController class] titleStr:@"" nomalImage:@"icon_tab_phb_en" selectImage:@"icon_tab_phb_en" index:1];
    ...
    [self addControllerWithClass:[YCJShopViewController class] titleStr:@"" nomalImage:@"icon_tab_sc_en" selectImage:@"icon_tab_sc_en" index:3];
   
    [self addControllerWithClass:[YCJMineViewController class] titleStr:@"" nomalImage:@"icon_tab_grzs_en" selectImage:@"icon_tab_grzs_en" index:4];
