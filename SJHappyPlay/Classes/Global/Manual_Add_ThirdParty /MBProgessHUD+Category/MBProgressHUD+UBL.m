...
//  UBallLive
//
//  Created by Jordon on 2020/11/18.
//
...
+ (void)showSuccess:(NSString *)success toView:(UIView *)view{
    ...
    if(!success || [@"" isEqualToString:success])return;
...
+ (MBProgressHUD *)showLoadingMessage:(NSString *)message toView:(UIView *_Nullable)view {
...
+ (MBProgressHUD *)showLoadingMessage:(NSString *)message toView:(UIView *)view delay:(float)delay {
    ...
    hud.label.font = kPingFangRegularFont(14);
...
- (void)showText:(NSString *)text delay:(float)delay {
    ...
    self.label.font = kPingFangRegularFont(14);
